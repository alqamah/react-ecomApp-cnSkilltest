      ...
      <div className="card h-100">
        <div className="card-body d-flex flex-column">
          ...
          <div className="btn-grp">
            <button className="btn btn-outline-primary me-0" onClick={() => setIsEditing(true)}>Edit</button>
            <button className="btn btn-outline-danger me-0" onClick={handleDelete}>Delete</button>
